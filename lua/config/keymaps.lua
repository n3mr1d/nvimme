...
-- di ~/.config/nvim/lua/config/keymaps.lua
-- atau file keymaps lain sesuai struktur setupmu

-- hapus mapping default (opsional, biar tidak bentrok)
pcall(vim.keymap.del, "n", "<leader><leader>")

-- ganti dengan Telescope
