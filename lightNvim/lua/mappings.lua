...
local snacks_picker = {
  ...
  { "<leader>p", function() Snacks.picker.lsp_symbols() end, desc = "LSP Symbols" },
  ...
  { "]]", function() Snacks.words.jump(vim.v.count0) end, desc = "Next Reference", mode = { "n", "t" } },
  { "[[", function() Snacks.words.jump(-vim.v.count0) end, desc = "Prev Reference", mode = { "n", "t" } },
  { "<leader>N", function()
      Snacks.win({
...
local editor_mappings = {
  ...
  -- General
  { mode = "n", lhs = "<Esc>", rhs = "<cmd>noh<CR>", desc = "Clear highlights" },
  ...
  -- Format
  { mode = { "n", "x" }, lhs = "<leader>fm", rhs = function() require("conform").format { lsp_fallback = true } end, desc = "Format file" },
  ...
  { mode = "n", lhs = "<tab>", rhs = function() require("nvchad.tabufline").next() end, desc = "Buffer goto next" },
  { mode = "n", lhs = "<S-tab>", rhs = function() require("nvchad.tabufline").prev() end, desc = "Buffer goto prev" },
  { mode = "n", lhs = "<leader>x", rhs = function() require("nvchad.tabufline").close_buffer() end, desc = "Buffer close" },
  ...
  { mode = "n", lhs = "<leader>h", rhs = function() require("nvchad.term").new { pos = "sp" } end, desc = "New horizontal term" },
  { mode = "n", lhs = "<leader>v", rhs = function() require("nvchad.term").new { pos = "vsp" } end, desc = "New vertical term" },
  { mode = { "n", "t" }, lhs = "<A-v>", rhs = function() require("nvchad.term").toggle { pos = "vsp", id = "vtoggleTerm" } end, desc = "Toggleable vertical term" },
  { mode = { "n", "t" }, lhs = "<A-h>", rhs = function() require("nvchad.term").toggle { pos = "sp", id = "htoggleTerm" } end, desc = "Toggleable horizontal term" },
  { mode = { "n", "t" }, lhs = "<A-i>", rhs = function() require("nvchad.term").toggle { pos = "float", id = "floatTerm" } end, desc = "Toggle floating term" },

  -- WhichKey
  { mode = "n", lhs = "<leader>wK", rhs = "<cmd>WhichKey <CR>", desc = "WhichKey all keymaps" },
  { mode = "n", lhs = "<leader>wk", rhs = function() vim.cmd("WhichKey " .. vim.fn.input "WhichKey: ") end, desc = "WhichKey query lookup" },

  -- Menu (Keyboard)
  { mode = "n", lhs = "<C-t>", rhs = function() require("menu").open("default") end, desc = "Open menu" },

  -- Mouse users + nvimtree users
  { mode = { "n", "v" }, lhs = "<RightMouse>", rhs = function()
